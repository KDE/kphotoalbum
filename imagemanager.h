...
public:
    LoadInfo();
    LoadInfo( const QString& fileName, int width,  int heigth, int angle, ImageClient* client);
...
public:
    void load( const QString& fileName, ImageClient* client, int angle, int width, int height, bool cache, bool priority );
    LoadInfo next();
